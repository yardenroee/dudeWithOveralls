...
let game = new _game_js__WEBPACK_IMPORTED_MODULE_1__["default"](ctx, canvas, _levels__WEBPACK_IMPORTED_MODULE_0__["level1"]);
let splash = true;
if (splash) {
    let image = new Image();
    ...
    document.addEventListener("keydown", (e) => {
        ...
        if(e.keyCode === 13 && game.state.gameOver) {
            ...
            ctx.clearRect(0, 0, canvas.width, canvas.height);
             game = new _game_js__WEBPACK_IMPORTED_MODULE_1__["default"](ctx, canvas, _levels__WEBPACK_IMPORTED_MODULE_0__["level1"]);
            game.draw();
        }
    });
}
