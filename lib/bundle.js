...
class Game {
    constructor(ctx, canvas, level) {
        ...
        this.levels = [_levels__WEBPACK_IMPORTED_MODULE_0__["level1"], _levels__WEBPACK_IMPORTED_MODULE_0__["level2"], _levels__WEBPACK_IMPORTED_MODULE_0__["level3"], _levels__WEBPACK_IMPORTED_MODULE_0__["level4"]];
...
class Level {
    ...
    drawLevel() {
        ...
        if(this.level.message) {
            ...
            this.ctx.fillText(this.level.message, this.canvas.width/2, 50);
        }
    }
...
const level4 = {
    levelNum: 4,
    message: "YOU NEVER REALLY HAD A CHANCE",
    tilesX: [
        342,
        372,
        404,
...
const game = new _game_js__WEBPACK_IMPORTED_MODULE_1__["default"](ctx, canvas, _levels__WEBPACK_IMPORTED_MODULE_0__["level1"]);
let splash = true;
...
if (splash) {
    ...
    document.addEventListener("keydown", (e) => {
        ...
        if(e.keyCode === 13 && game.state.gameOver) {
            ctx.clearRect(0, 0, canvas.width, canvas.height);
            let newGame = new _game_js__WEBPACK_IMPORTED_MODULE_1__["default"](ctx, canvas, _levels__WEBPACK_IMPORTED_MODULE_0__["level1"]);
            newGame.draw();
        }
    });
}
